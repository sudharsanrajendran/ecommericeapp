...
class tTexttheme{
  ...
  static TextTheme textlighttheme= TextTheme(
    ...
    labelMedium:const TextStyle().copyWith(fontSize: 12.0,fontWeight: FontWeight.w500,color: Colors.black.withOpacity(0.5)),
  );
  static TextTheme textdarktheme= TextTheme(
    ...
    labelMedium:const TextStyle().copyWith(fontSize: 12.0,fontWeight: FontWeight.w500,color: Colors.white.withOpacity(0.5)),
